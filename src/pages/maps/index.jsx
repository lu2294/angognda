...
class ZMap extends Component {
    ...
    initMainMap() {
        ...
        var overlay = new L.echartsLayer(map, window.echarts)
        ...
        axios.get(`http://7xp3u9.com1.z0.glb.clouddn.com/srcmigration.json`)
        // $.ajax({
        ...
        //             })
        //         }
        //         option.series[0].markLine.data = data.allLine
        //             .sort(function (a, b) {
        //                 return b.num - a.num
        //             })
        //             .slice(0, 3000)
        ...
        //     }).setView([31.676898, 118.557929], 14)
